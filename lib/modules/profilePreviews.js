...
var ces__inlineProfiles = (function(){
  ...
  var profileLinks,
      ...
      selector = selectors[initData.__pageType] || selectors.default,
      penCommentsHandled = false,
      isGridView = (function(){
        return !!initData.__pageType.match(/^(home|explore-posts|explore-pens|explore-collections|collection)$/);
      })(),
  ...
  Preview.prototype.addPensToPreview = function() {
    var pens = this.pens,
        pensWrapper = this.template.find(".ces__profile__pens");
  ...
  Preview.prototype.position = function() {
    var
      offset = this.profileLink.offset(),
      height = this.profileLink.height();
