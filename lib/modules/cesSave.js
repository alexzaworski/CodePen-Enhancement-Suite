...
var ces__sav = (function(){
  ...
  // Necessary otherwise CodePen starts doubling up on the slashes in newlines
  // when it saves and they output into the editors/break everything.
  //
  // I'm sure there's a better way to address the root cause but I'm not sure what it is.
  currentPenSettings.html = currentPenSettings.html.replace(/\\n/g, "\n");
  currentPenSettings.css = currentPenSettings.css.replace(/\\n/g, "\n");
  currentPenSettings.js = currentPenSettings.js.replace(/\\n/g, "\n");
