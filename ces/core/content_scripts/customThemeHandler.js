...
(function customThemeHandler () {
  ...
  var defaultCSS = '.box, .editor .top-boxes, .CodeMirror-gutter-wrapper, body.project .editor-pane, body.project .editor{background:#272825;}.CodeMirror-cursor{border-left-color:#ffffff;}.CodeMirror pre, .box pre,.editor .top-boxes pre,.CodeMirror-gutter-wrapper pre{color:#ffffff;}.cm-keyword{color:#FA2D7D;}.cm-atom{color:#ae81ff;}.box-html .cm-atom{color:#ae81ff;}.cm-def{color:#F79900;}.cm-variable{color:#71D7D0;}.cm-variable-2{color:#AE81FF;}.cm-variable-3{color:#a6e22e;}.cm-header{color:#FA2D7D;}.cm-number{color:#B78CFF;}.cm-property{color:#71D7D0;}.cm-attribute{color:#a6e22e;}.cm-builtin{color:#a6e22e;}.cm-qualifier{color:#a6e22e;}.cm-operator{color:#FA2D7D;}.cm-meta{color:#FA2D7D;}.cm-string{color:#E9E07F;}.cm-string-2{color:#E9E07F;}.cm-tag{color:#FA2D7D;}.box-css .cm-tag{color:#f92672;}.cm-tag.cm-bracket{color:#ffffff;}.CodeMirror-linenumber{color:#575344;}.CodeMirror-guttermarker-subtle{color:#575344;}.cm-comment{color:#575344;}.cm-searching, .CodeMirror-focused .CodeMirror-selected, .CodeMirror-selected{background-color:#414141;}';
