window.presets = (function () {
  ...
  for (var preset in presets) {
    var expectedElements = 27; // magic numbers hooooo
    var presetName = preset;
    preset = presets[preset];
    var numElements = preset.elements.length;
    if (numElements !== expectedElements) {
      console.warn(presetName + ': Invalid number of elements (saw ' + numElements + ', expected ' + expectedElements);
    }
    preset.elements.forEach(validateElement);
  }
  return presets;
})();
