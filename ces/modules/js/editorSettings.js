...
(function() {
  ...
  function cesSaveInit() {
    ...
    } else { // Otherwise we can just go ahead and do whatevs.
      saveEditorSettings();
    }
  }
  ...
  function getNewEditorSettings() {
    ...
    newEditorSettings.theme = $("#editor-theme input:checked").val();
    newEditorSettings.font_size = $("#font_size option:checked").val();
    newEditorSettings.font_type = $("#font_type option:checked").val();
